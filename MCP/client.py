...
from MCP.schema import MCPContext, MCPHeader, DomainMetadata, ContextType, ConfidenceLevel
...
async def main():
    async with MCPClient("test-client", "http://localhost:8000") as client:
        # Create a sample context
        context = client.create_context(
            domain_type=ContextType.NETWORK_DATA,
            payload={"packet_loss": 0.01, "latency": 20, "throughput": 1000}
        )
